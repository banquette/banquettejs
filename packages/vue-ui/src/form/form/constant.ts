 ...
 */
export const FORM_GENERIC_LOAD_REQUESTS_TAG = Symbol('form-load-requests-tag');
export const FORM_GENERIC_PERSIST_REQUESTS_TAG = Symbol('form-persist-requests-tag');
