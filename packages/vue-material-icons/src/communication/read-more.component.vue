...
export default /* @__PURE__ */ ((_) => {
    return r('read-more', {
        ...
        render() {
            ...
            if (v === 'round')
    return h('svg',{"viewBox":c ? '2 7 20 10' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M14 9h7c.55 0 1-.45 1-1s-.45-1-1-1h-7c-.55 0-1 .45-1 1s.45 1 1 1zm7 6h-7c-.55 0-1 .45-1 1s.45 1 1 1h7c.55 0 1-.45 1-1s-.45-1-1-1zm0-4h-4c-.55 0-1 .45-1 1s.45 1 1 1h4c.55 0 1-.45 1-1s-.45-1-1-1zM8.85 7.85a.5.5 0 0 0-.85.36V11H3c-.55 0-1 .45-1 1s.45 1 1 1h5v2.79c0 .45.54.67.85.35l3.79-3.79c.2-.2.2-.51 0-.71L8.85 7.85z"},[])]);
return h('svg',{"viewBox":c ? '2 7 20 10' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M13 7h9v2h-9zm0 8h9v2h-9zm3-4h6v2h-6zm-3 1L8 7v4H2v2h6v4z"},[])]);
        }
    });
})();
</script>