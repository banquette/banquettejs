...
export default /* @__PURE__ */ ((_) => {
    return r('music-note', {
        ...
        render() {
            ...
            if (v === 'twotone')
    return h('svg',{"viewBox":c ? '6 3 12 18' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('circle',{"cx":"10.01","cy":"17",r:"2","opacity":"0.3"},[]),h('path',{d:"m12 3 .01 10.55c-.59-.34-1.27-.55-2-.55a4.001 4.001 0 1 0 0 8c2.22 0 3.99-1.79 3.99-4V7h4V3h-6zm-1.99 16c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z"},[])]);
if (v === 'round')
