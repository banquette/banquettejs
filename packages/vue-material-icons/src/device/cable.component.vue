...
const IMaterialCable = /* @__PURE__ */ ((_) => {
    return r('cable', {
        ...
        render() {
            ...
            if (v === 'sharp')
    return h('svg',{"viewBox":c ? '3 3 18 18' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M20 5V3h-4v2h-1v5h2v9h-4V3H5v11H3v5h1v2h4v-2h1v-5H7V5h4v16h8V10h2V5z"},[])]);
if (v === 'round')
