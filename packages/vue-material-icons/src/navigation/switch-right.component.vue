...
export default /* @__PURE__ */ ((_) => {
    return r('switch-right', {
        ...
        render() {
            ...
            if (v === 'twotone')
    return h('svg',{"viewBox":c ? '3 5 18 14' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M15.5 15.38V8.62L18.88 12l-3.38 3.38","opacity":"0.3"},[]),h('path',{d:"M15.5 15.38V8.62L18.88 12l-3.38 3.38M14 19l7-7-7-7v14zm-4 0V5l-7 7 7 7z"},[])]);
if (v === 'round')
