...
const IMaterialAirlineSeatReclineExtra = /* @__PURE__ */ ((_) => {
    return r('airline-seat-recline-extra', {
...
export default IMaterialAirlineSeatReclineExtra;
</script>