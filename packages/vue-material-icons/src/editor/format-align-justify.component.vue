...
const IMaterialFormatAlignJustify = /* @__PURE__ */ ((_) => {
    return r('format-align-justify', {
...
return h('svg',{"viewBox":c ? '3 3 18 18' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M3 21h18v-2H3zm0-4h18v-2H3zm0-4h18v-2H3zm0-4h18V7H3zm0-6v2h18V3z"},[])]);
        }
    });
})();

export default IMaterialFormatAlignJustify;
</script>