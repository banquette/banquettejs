...
const IMaterialSuperscript = /* @__PURE__ */ ((_) => {
    return r('superscript', {
        ...
        render() {
            ...
            if (v === 'sharp')
    return h('svg',{"viewBox":c ? '5.88 4 17.12 16' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M20 7v1h3v1h-4V6h3V5h-3V4h4v3zM5.88 20h2.66l3.4-5.42h.12l3.4 5.42h2.66l-4.65-7.27L17.81 6h-2.68l-3.07 4.99h-.12L8.85 6H6.19l4.32 6.73z"},[])]);
if (v === 'round')
...
return h('svg',{"viewBox":c ? '5.88 4 17.12 16' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M22 7h-2v1h3v1h-4V7c0-.55.45-1 1-1h2V5h-3V4h3c.55 0 1 .45 1 1v1c0 .55-.45 1-1 1M5.88 20h2.66l3.4-5.42h.12l3.4 5.42h2.66l-4.65-7.27L17.81 6h-2.68l-3.07 4.99h-.12L8.85 6H6.19l4.32 6.73z"},[])]);
        }
    });
})();

export default IMaterialSuperscript;
</script>