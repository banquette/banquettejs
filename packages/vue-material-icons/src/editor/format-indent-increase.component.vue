...
const IMaterialFormatIndentIncrease = /* @__PURE__ */ ((_) => {
    return r('format-indent-increase', {
...
return h('svg',{"viewBox":c ? '3 3 18 18' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M3 21h18v-2H3zM3 8v8l4-4zm8 9h10v-2H11zM3 3v2h18V3zm8 6h10V7H11zm0 4h10v-2H11z"},[])]);
        }
    });
})();

export default IMaterialFormatIndentIncrease;
</script>