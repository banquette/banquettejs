...
export default {
    ...
    render() {
        ...
        if (v === 'twotone')
    return h('svg',{"viewBox":c ? '1.6 3 20.8 18' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M16.05 19h-8.1l-4.04-7 4.04-7h8.1l4.04 7z","opacity":"0.3"},[]),h('path',{d:"M17.2 3H6.8l-5.2 9 5.2 9h10.4l5.2-9-5.2-9zm-1.15 16h-8.1l-4.04-7 4.04-7h8.09l4.04 7-4.03 7z"},[])]);
if (v === 'round')
