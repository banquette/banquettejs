...
@Component('i-material-signal-cellular-1-bar')
export default class IconMaterialSignalCellular1Bar {
...
<template>
    <svg :width="width" :height="height || (!width ? '1em' : null)" :fill="color" :viewBox="crop ? '2 2 20 20' : '0 0 24 24'"><path d="M2 22h20V2L2 22z" fill-opacity=".3"/><path d="M12 12 2 22h10V12z"/></svg>
</template>