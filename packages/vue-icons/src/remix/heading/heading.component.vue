...
<template>
    <span><svg :width="size" :height="size" :fill="color" :viewBox="crop ? '5 4 14 17' : '0 0 24 24'"><path fill="none" d="M0 0h24v24H0z"/><path d="M17 11V4h2v17h-2v-8H7v8H5V4h2v7z"/></svg></span>
</template>