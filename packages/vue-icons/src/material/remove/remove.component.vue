...
@Component('i-material-remove')
export default class IconMaterialRemove {
...
<template>
    <svg :width="!crop ? size : null" :height="size" :fill="color" :viewBox="crop ? '5 11 14 2' : '0 0 24 24'"><path d="M19 13H5v-2h14v2z"/></svg>
</template>