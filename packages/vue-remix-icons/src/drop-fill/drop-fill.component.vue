...
<template>
    <svg :width="width" :height="height || (!width ? '1em' : null)" :fill="color" :viewBox="crop ? '3 0.27 18 21.73' : '0 0 24 24'"><path d="M5.636 6.636 12 .272l6.364 6.364a9 9 0 1 1-12.728 0z"/></svg>
</template>