...
return h('svg',{"viewBox":c ? '1 2 22.01 19' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"M7 20.981a6.5 6.5 0 0 1-2.936-12 8.001 8.001 0 0 1 15.872 0 6.5 6.5 0 0 1-2.936 12V21H7v-.019zM13 13h3l-4-5-4 5h3v4h2v-4z"},[])]);
        }
    });
})();
</script>