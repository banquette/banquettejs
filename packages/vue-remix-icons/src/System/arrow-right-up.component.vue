...
const IRemixArrowRightUp = /* @__PURE__ */ ((_) => {
    return r('arrow-right-up', {
        ...
        render() {
            ...
            if (v === 'line')
    return h('svg',{"viewBox":c ? '5.98 6 12.02 12.02' : '0 0 24 24',"width":w,"height":s,"fill":f},[h('path',{d:"m16.004 9.414-8.607 8.607-1.414-1.414L14.589 8H7.004V6h11v11h-2z"},[])]);
...
export default IRemixArrowRightUp;
</script>