...
// Slight modifications have been made to make it valid TypeScript.
...
if (isUndefined(JSON.decycle)) {
    JSON.decycle = function decycle(object: any, replacer: any) {
        "use strict";
...
if (typeof JSON.retrocycle !== "function") {
    JSON.retrocycle = function retrocycle($: string) {
        "use strict";
...
// the path.
            ...
            if (value && typeof value === "object") {
                if (isArray(value)) {
                    value.forEach(function (element: any, i: any) {
