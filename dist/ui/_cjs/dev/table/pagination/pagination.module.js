...
var PaginationModule = /** @class */ (function () {
    function PaginationModule() {
         ...
         */
        this.position = constant.PaginationPosition.Top;
        /**
         ...
         */
        this._strategy = constant.PaginationStrategy.Offset;
        /**
    ...
    Object.defineProperty(PaginationModule.prototype, "page", {
        ...
        set: function (value) {
            if (this.strategy === constant.PaginationStrategy.Offset && this._page !== value) {
                this._page = value;
    ...
    Object.defineProperty(PaginationModule.prototype, "pageId", {
        ...
        set: function (value) {
            if (this.strategy === constant.PaginationStrategy.Id && this._pageId !== value) {
                this._pageId = value;
                this.notifyChange();
            }
        },
    ...
    PaginationModule.prototype.previous = function () {
        ...
        if (this.strategy === constant.PaginationStrategy.Offset) {
    ...
    PaginationModule.prototype.goTo = function (numOrId) {
        if (this.strategy === constant.PaginationStrategy.Offset) {
            if (isValidNumber.isValidNumber(numOrId)) {
                this.page = numOrId;
            }
        }
        else {
    ...
    PaginationModule.prototype.import = function (save) {
        this.page = Math.min(1, ensureInteger.ensureInteger(save.page));
        this.nextPageId = save.nextPageId;
        this.previousPageId = save.previousPageId;
        this.itemsPerPage = ensureInteger.ensureInteger(save.itemsPerPage);
    };
    /**
    ...
    PaginationModule.prototype.digestServerResponse = function (response) {
        ...
        if (this.strategy === constant.PaginationStrategy.Offset) {
            this._page = Math.max(1, ensureInteger.ensureInteger(response.page));
        }
        else if (this.strategy === constant.PaginationStrategy.Id) {
        ...
        if (!isUndefined.isUndefined(response.itemsPerPage)) {
        ...
        this.eventDispatcher.dispatch(constant.PaginationEvents.Invalidated);
        this.changed = false;
    };
    /**
    ...
    PaginationModule.prototype.onChange = function (cb) {
        return this.eventDispatcher.subscribe(constant.PaginationEvents.Changed, cb);
    };
    /**
    ...
    PaginationModule.prototype.onInvalidate = function (cb) {
        return this.eventDispatcher.subscribe(constant.PaginationEvents.Invalidated, cb);
    };
    /**
    ...
    PaginationModule.prototype.notifyChange = function () {
        this.changed = true;
        this.eventDispatcher.dispatch(constant.PaginationEvents.Changed);
    };
    PaginationModule = _tslib.__decorate([
