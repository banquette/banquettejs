...
var noop_valueTransformer = require('./noop.value-transformer.js');
...
var ControlModule = /** @class */ (function () {
    ...
    function ControlModule(control, valueTransformer) {
        if (valueTransformer === void 0) { valueTransformer = noop_valueTransformer.NoopTransformer; }
        var _this = this;
        ...
        this.subscribeToExternalEvent = (function () {
            ...
            return function (event, cb) {
                ...
                return function () {
                    if (!isUndefined.isUndefined(_this.externalEvents[localId])) {
        ...
        this.defineMutableProxy = function (target, property, value, callback) {
            var hasCallback = !isUndefined.isUndefined(callback);
            ...
            Object.defineProperty(target, property, {
                ...
                set: function (value) {
                    ...
                    if (!_this.allowProtectedMutations) {
                        throw new usage_exception.UsageException("You can't change the value of \"".concat(property, "\" from the view."));
                    }
                    _this.protectedViewData[property] = value;
                }
            });
    ...
    ControlModule.prototype.setControl = function (control) {
        ...
        this.unsubscribeMethods = [
            ...
            this.activeControl.onStateChanged(function (event) {
                if (!isUndefined.isUndefined(_this.viewData[event.state])) {
        ...
        for (var _b = 0, _c = getObjectKeys.getObjectKeys(this.externalEvents); _b < _c.length; _b++) {
            var id = _c[_b];
    ...
    ControlModule.prototype.buildViewData = function (viewData) {
        ...
        viewData = extend.extend(viewData, {
            tabIndex: 0,
            ...
            onFocus: proxy.proxy(this.onFocus, this),
            onBlur: proxy.proxy(this.onBlur, this),
            ...
            focus: proxy.proxy(this.onFocus, this),
            blur: proxy.proxy(this.onBlur, this)
        });
        return viewData;
    };
    /**
