...
import { UploadStatus } from './constant.js';
...
var FormFile = /** @class */ (function () {
    ...
    Object.defineProperty(FormFile.prototype, "totalSize", {
        ...
        set: function (value) {
            ...
            this.totalSizeText = value !== null ? byteCountToHumanSize(value) : null;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(FormFile.prototype, "uploadedSize", {
        ...
        set: function (value) {
            ...
            this.uploadedSizeText = value !== null ? byteCountToHumanSize(value) : null;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(FormFile.prototype, "uploading", {
         ...
         * Status shorthands.
         */
        get: function () { return this.status === UploadStatus.Uploading; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(FormFile.prototype, "paused", {
        get: function () { return this.status === UploadStatus.Paused; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(FormFile.prototype, "succeeded", {
        get: function () { return this.status === UploadStatus.Succeeded; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(FormFile.prototype, "failed", {
        get: function () { return this.status === UploadStatus.Failed; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(FormFile.prototype, "remote", {
        get: function () { return this.status === UploadStatus.Remote; },
        enumerable: false,
        configurable: true
    });
    /**
