...
var WeakObjectMap = /** @class */ (function () {
    ...
    WeakObjectMap.prototype.has = function (alias) {
        return !isUndefined.isUndefined(this.map[alias]);
    };
    /**
    ...
    WeakObjectMap.prototype.getRef = function (alias) {
        var _this = this;
        if (isUndefined.isUndefined(this.map[alias])) {
            return null;
        }
        this.clearTimer(alias);
        ...
        return {
            ...
            release: function () {
                if (!releaseCalled && !isUndefined.isUndefined(_this.map[alias])) {
                    releaseCalled = true;
    ...
    WeakObjectMap.prototype.scheduleMapRemoval = function (alias) {
        if (isUndefined.isUndefined(this.removeTimers[alias])) {
            setTimeout(proxy.proxy(this.remove, this), 30000);
        }
    };
    /**
...
exports.WeakObjectMap = WeakObjectMap;
