...
function makeReassignable(obj) {
    if (!isObject.isObject(obj) || !isUndefined.isUndefined(obj['__bt_reassignable'])) {
        return obj;
    }
    var wrapped = {};
...
function unmakeReassignable(value) {
    if (isObject.isObject(value) && !isUndefined.isUndefined(value[ProxySymbol])) {
...
function isReassignable(value) {
    return isObject.isObject(value) && !isUndefined.isUndefined(value[ProxySymbol]);
}

exports.isReassignable = isReassignable;
exports.makeReassignable = makeReassignable;
exports.reassign = reassign;
exports.unmakeReassignable = unmakeReassignable;
