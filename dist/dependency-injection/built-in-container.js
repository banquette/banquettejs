...
var BuiltInContainer = /** @class */ (function () {
        ...
        return new Proxy(output, {
            get: function (target, name) {
                if (lastTagsVersion === MetadataContainer.TagsVersion) {
                    return !isUndefined(name) ? target[name] : target;
                }
                lastTagsVersion = MetadataContainer.TagsVersion;
                target.splice(0, target.length);
                var metadata = MetadataContainer.GetForTag(tag);
    ...
    BuiltInContainer.prototype.resolveInjectable = function (identifier) {
        var _a;
        var metadata = MetadataContainer.GetOrFail(identifier);
        ...
        try {
            ...
            instance = new ((_a = metadata.ctor).bind.apply(_a, __spreadArray([void 0], constructorArgs, false)))();
    ...
    BuiltInContainer.prototype.assignResolutionInstancesPropertyDependencies = function () {
        var instances = __spreadArray([], this.resolutionInstances, true);
        this.resolutionInstances = [];
        for (var _i = 0, instances_1 = instances; _i < instances_1.length; _i++) {
            var inst = instances_1[_i];
            var metadata = MetadataContainer.GetOrFail(inst.constructor);
    ...
    BuiltInContainer.prototype.pushToStack = function (identifier) {
        if (this.resolutionStack.indexOf(identifier) >= 0) {
            ...
            this.resolutionStack = [];
            throw new UsageException("Circular dependency found: ".concat(stackNames));
        }
