...
})(TransformResultStatus || (TransformResultStatus = {}));
var TransformResult = /** @class */ (function () {
    ...
    TransformResult.prototype.delayResponse = function (promise) {
        ...
        if (this.promise === null) {
            this.promise = new Promise(function (resolve, reject) {
                ...
                _this.setStatus(TransformResultStatus.Ready);
    ...
    TransformResult.prototype.setStatus = function (status) {
        this.status = status;
        this.ready = this.status === TransformResultStatus.Ready;
        this.error = this.status === TransformResultStatus.Error;
        this.waiting = this.status === TransformResultStatus.Waiting;
    };
...
export { TransformResult, TransformResultStatus };
