...
var AbstractRequestBuilder = /** @class */ (function () {
    ...
    AbstractRequestBuilder.prototype.get = function () {
        this._method = constants.HttpMethod.GET;
        return this;
    };
    /**
    ...
    AbstractRequestBuilder.prototype.post = function () {
        this._method = constants.HttpMethod.POST;
        return this;
    };
    /**
    ...
    AbstractRequestBuilder.prototype.put = function () {
        this._method = constants.HttpMethod.PUT;
        return this;
    };
    /**
    ...
    AbstractRequestBuilder.prototype.delete = function () {
        this._method = constants.HttpMethod.DELETE;
        return this;
    };
    /**
    ...
    AbstractRequestBuilder.prototype.param = function (name, value, type) {
        if (type === void 0) { type = constants.UrlParameterType.Auto; }
        if (isUndefined.isUndefined(this._params)) {
            this._params = {};
        }
    ...
    AbstractRequestBuilder.prototype.headers = function (headers) {
        if (isUndefined.isUndefined(this._headers)) {
            this._headers = {};
        }
    ...
    AbstractRequestBuilder.prototype.payload = function (payload, type) {
        this._payload = !isUndefined.isUndefined(payload) ? payload : null;
        if (!isUndefined.isUndefined(type)) {
    ...
    AbstractRequestBuilder.prototype.extras = function (extras) {
        if (isUndefined.isUndefined(this._extras)) {
            this._extras = {};
        }
...
exports.AbstractRequestBuilder = AbstractRequestBuilder;
