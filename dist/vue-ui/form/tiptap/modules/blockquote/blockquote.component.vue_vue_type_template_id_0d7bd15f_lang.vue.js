 ...
 */
import { resolveComponent, resolveDirective, withDirectives, openBlock, createBlock, withCtx, createVNode, createTextVNode, toDisplayString, createCommentVNode } from 'vue';

function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_i_material_format_quote = resolveComponent("i-material-format-quote");
  ...
  return (_ctx.editor)
    ? withDirectives((openBlock(), createBlock(_component_bt_button, {
        ...
        "data-active": _ctx.editor.isActive('blockquote') ? '' : null
      }, {
        default: withCtx(function () { return [
          createVNode(_component_i_material_format_quote, {
            width: "1em",
            height: "0.8em",
            crop: ""
          }),
