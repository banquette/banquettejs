...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_i_material_format_italic = resolveComponent("i-material-format-italic");
  ...
  return (_ctx.editor)
    ? (openBlock(), createBlock(_component_bt_button, {
        ...
        "data-active": _ctx.editor.isActive('italic') ? '' : null
      }, {
        default: withCtx(function () { return [
          createVNode(_component_i_material_format_italic, { crop: "" }),
          (_ctx.i18n.popover)
