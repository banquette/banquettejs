...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_i_material_format_underlined = resolveComponent("i-material-format-underlined");
  ...
  return (_ctx.editor)
    ? (openBlock(), createBlock(_component_bt_button, {
        ...
        "data-active": _ctx.editor.isActive('underline') ? '' : null
      }, {
        default: withCtx(function () { return [
          createVNode(_component_i_material_format_underlined, { crop: "" }),
          (_ctx.i18n.popover)
