...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    ...
    vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
      vue.createCommentVNode(" :visible is always `true` but only act as a default value because if the user define a value for the \"visible\" prop, it will be in `$attrs` and override the value. "),
      vue.createCommentVNode(" Also, defining the \"visible\" prop disable the default behavior of the popover, based on mouse events. "),
      (_ctx.realTarget !== null)
        ? (vue.openBlock(), vue.createBlock(_component_bt_popover, vue.mergeProps({
            key: 0,
            class: "bt-dropdown",
            visible: true,
