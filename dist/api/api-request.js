...
var ApiRequest = /** @class */ (function () {
    ...
    ApiRequest.prototype.toEndpointOverride = function () {
        return new ApiEndpointOverride(this.method, this.paramsToPrimitives(), this.headers, this.timeout, this.retry, this.retryDelay, this.priority, this.withCredentials, this.mimeType, this.payloadType, this.responseType, this.tags, this.extras);
    };
    /**
