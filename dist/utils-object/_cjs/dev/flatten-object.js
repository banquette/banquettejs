...
function doFlatten(obj, concatenator, maxDepth, currentDepth) {
    return Object.keys(obj).reduce(function (acc, key) {
        var _a;
        if (!isObject.isObject(obj[key]) || (maxDepth !== 0 && currentDepth >= maxDepth)) {
            return _tslib.__assign(_tslib.__assign({}, acc), (_a = {}, _a[key] = obj[key], _a));
        }
        var flattenedChild = doFlatten(obj[key], concatenator, maxDepth, currentDepth + 1);
        return _tslib.__assign(_tslib.__assign({}, acc), Object.keys(flattenedChild).reduce(function (childAcc, childKey) {
            var _a;
            return (_tslib.__assign(_tslib.__assign({}, childAcc), (_a = {}, _a["".concat(key).concat(concatenator).concat(childKey)] = flattenedChild[childKey], _a)));
        }, {}));
    }, {});
}
/**
        ...
        for (var _i = 0, _a = Object.keys(result); _i < _a.length; _i++) {
            ...
            if (parts.length > 0) {
                ...
                if (kept.length > 0) {
                    ...
                    if (!isObject.isObject(clone[newKey])) {
                        clone[newKey] = {};
                    }
                ...
                for (var i = 0; i < parts.length - 1; ++i) {
                    if (!isObject.isObject(current[parts[i]])) {
                        current[parts[i]] = {};
                    }
