 ...
 */
import { __extends, __awaiter, __decorate, __param, __metadata, __generator } from '../_virtual/_tslib.js';
...
var CookiesAdapter = /** @class */ (function (_super) {
    __extends(CookiesAdapter, _super);
    ...
    CookiesAdapter.prototype.getSync = function (key, defaultValue) {
        ...
        return !isUndefined(defaultValue) ? defaultValue : null;
    };
    /**
    ...
    CookiesAdapter = __decorate([
        Service(StorageAdapterTag),
        __param(0, InjectLazy(function () { return ConfigurationService; })),
        __metadata("design:paramtypes", [ConfigurationService])
    ], CookiesAdapter);
    return CookiesAdapter;
}(AbstractAdapter));

export { CookiesAdapter };
