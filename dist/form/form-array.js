 ...
 */
import { __extends, __spreadArray } from './_virtual/_tslib.js';
...
var FormArray = /** @class */ (function (_super) {
    ...
    FormArray.prototype.append = function (component) {
        ...
        this.dispatch(FormEvents.ComponentAdded, function () {
            var index = _this.children_.length - 1;
            return new ComponentAddedFormEvent(_this, _this.children_[index].decorated, index);
        });
    };
    /**
    ...
    FormArray.prototype.prepend = function (component) {
        ...
        this.dispatch(FormEvents.ComponentAdded, function () { return new ComponentAddedFormEvent(_this, _this.children_[0].decorated, 0); });
    };
    /**
    ...
    FormArray.prototype.set = function (index, component) {
        ...
        this.updateCollection(function () {
            ...
            if (index < _this.children_.length) {
                ...
                throw new UsageException("There is no component at index \"".concat(index, "\" and index \"").concat(index, "\" is not the next contiguous identifier."));
            }
            child.propagateStatesToParent();
        });
        this.dispatch(FormEvents.ComponentAdded, function () { return new ComponentAddedFormEvent(_this, _this.children_[index].decorated, index); });
    };
    /**
    ...
    FormArray.prototype.remove = function (index) {
        ...
        this.dispatch(FormEvents.ComponentRemoved, function () { return new ComponentRemovedFormEvent(_this, removed.decorated, index); });
    ...
    FormArray.prototype.clear = function () {
        ...
        var _loop_1 = function (i) {
            this_1.dispatch(FormEvents.ComponentRemoved, function () { return new ComponentRemovedFormEvent(_this, children[i].decorated, i); });
        };
        var this_1 = this;
    ...
    FormArray.prototype.forEach = function (cb, filters) {
        ...
        var copy = __spreadArray([], this.children_, true);
