...
var FormObject = /** @class */ (function (_super) {
    _tslib.__extends(FormObject, _super);
    ...
    FormObject.prototype.set = function (identifier, component) {
        ...
        if (!isUndefined.isUndefined(this.children_[identifier])) {
        ...
        this.dispatch(constant.FormEvents.ComponentAdded, function () { return new componentAdded_formEvent.ComponentAddedFormEvent(_this, _this.children_[identifier].decorated, identifier); });
    };
    /**
    ...
    FormObject.prototype.setByPath = function (path, component) {
        var parts = ltrim.ltrim(path, '/').split('/');
        if (parts.length === 1) {
        ...
        do {
            if (!container.isGroup()) {
                throw new usage_exception.UsageException("A component was found at \"".concat(container.path, "\", but is not a container."));
            }
    ...
    FormObject.prototype.remove = function (identifier) {
        ...
        this.dispatch(constant.FormEvents.ComponentRemoved, function () { return new componentRemoved_formEvent.ComponentRemovedFormEvent(_this, removed.decorated, identifier); });
    ...
    FormObject.prototype.clear = function () {
        ...
        var _loop_1 = function (name_3) {
            this_1.dispatch(constant.FormEvents.ComponentRemoved, function () { return new componentRemoved_formEvent.ComponentRemovedFormEvent(_this, components[name_3].decorated, name_3); });
        };
        var this_1 = this;
    ...
    FormObject.prototype.has = function (identifier) {
        return !isUndefined.isUndefined(this.children_[identifier]);
    };
    /**
    ...
    FormObject.prototype.setValue = function (values) {
        for (var _i = 0, _a = Object.keys(values); _i < _a.length; _i++) {
            var name_4 = _a[_i];
            if (!isUndefined.isUndefined(this.children_[name_4])) {
    ...
    FormObject.prototype.setDefaultValue = function (values) {
        for (var _i = 0, _a = Object.keys(values); _i < _a.length; _i++) {
            var name_5 = _a[_i];
            if (!isUndefined.isUndefined(this.children_[name_5])) {
    ...
    FormObject.ValidateIdentifier = function (identifier) {
        ...
        if (!identifier) {
            throw new usage_exception.UsageException('You cannot add a child with an empty identifier to a form object.');
        }
        return identifier;
    };
    return FormObject;
