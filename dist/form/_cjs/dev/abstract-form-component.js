...
var removeFromArray = require('@banquette/utils-array/_cjs/dev/remove-from-array');
...
var validationResult = require('@banquette/validation/_cjs/dev/validation-result');
...
var AbstractFormComponent = /** @class */ (function () {
    function AbstractFormComponent() {
         ...
         */
        this.validationStrategy = constant.ValidationStrategy.Inherit;
        /**
         * The validation groups to use for this component.
         */
        this.validationGroups = constant.InheritValidationGroup;
        /**
         ...
         */
        this.activeStates = [
            constant.InverseState.Enabled,
            constant.InverseState.UnFocused,
            constant.InverseState.Pristine,
            constant.InverseState.UnTouched,
            constant.InverseState.NotBusy,
            constant.InverseState.UnChanged,
            constant.InverseState.Valid,
            constant.InverseState.Validated,
            constant.InverseState.NotValidating,
            constant.InverseState.Virtual
        ];
        /**
         ...
         */
        this.validationStatus = constant.ValidationStatus.Unknown;
        /**
         ...
         */
        this.basicStates = (_a = {},
            _a[constant.BasicState.Dirty] = [],
            _a[constant.BasicState.Touched] = [],
            _a[constant.BasicState.Changed] = [],
            _a[constant.BasicState.Busy] = [],
            _a[constant.BasicState.Invalid] = [],
            _a[constant.BasicState.NotValidated] = [],
            _a[constant.BasicState.Validating] = [],
            _a[constant.BasicState.Focused] = [],
            _a[constant.BasicState.Concrete] = [],
            _a);
        /**
        ...
        this.contextualizedStates = (_b = {},
            _b[constant.ContextualizedState.Disabled] = {},
            _b);
        /**
        ...
        /* final */ this.reset = (function () {
            return _this.proxifyWithContext(proxy.proxy(_this.doReset, _this), constant.CallContext.Reset);
        })();
    }
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "invalid", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Invalid].length > 0; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AbstractFormComponent.prototype, "notValidated", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.NotValidated].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "validating", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Validating].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "busy", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Busy].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "disabled", {
         ...
         */
        get: function () { return Object.keys(this.contextualizedStates[constant.ContextualizedState.Disabled]).length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "dirty", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Dirty].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "touched", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Touched].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "changed", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Changed].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "focused", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Focused].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "concrete", {
         ...
         */
        get: function () { return this.basicStates[constant.BasicState.Concrete].length > 0; },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AbstractFormComponent.prototype, "activeBasicStates", {
         ...
         */
        get: function () {
            return this.activeStates.filter(function (state) { return constant.BasicStates.indexOf(state) > -1; });
        },
        enumerable: false,
        configurable: true
    });
    ...
    AbstractFormComponent.prototype.setValidator = function (validator) {
        ...
        if (this.currentValidationResult !== null) {
            ...
            this.unmarkBasicState(constant.BasicState.Validating, this.id);
        }
        if (validator !== null) {
            var onFinish_1 = function () {
                if (_this.currentValidationResult && !_this.currentValidationResult.canceled) {
                    _this.unmarkBasicState(constant.BasicState.Validating, _this.id);
                    _this.unmarkBasicState(constant.BasicState.NotValidated, _this.id);
                }
                _this.currentValidationResult = null;
            };
            this.validator = createValidator.createValidator({
                validate: function (context) {
                    if (that.virtual) {
                        return context.result;
                    }
                    try {
                        that.markBasicState(constant.BasicState.Validating, that.id);
        ...
        if (this.validator !== null && this.concrete) {
            this.markBasicState(constant.BasicState.NotValidated, this.id);
        }
        else {
    ...
    AbstractFormComponent.prototype.setValidationGroups = function (groups) {
        this.validationGroups = groups !== null ? ensureArray.ensureArray(groups) : null;
    };
    /**
    ...
    AbstractFormComponent.prototype.markAsVirtual = function () {
        this.unmarkBasicState(constant.BasicState.Concrete, this.id);
        this.unmarkBasicState(constant.BasicState.NotValidated, this.id);
    };
    /**
    ...
    AbstractFormComponent.prototype.markAsConcrete = function () {
        this.markBasicState(constant.BasicState.Concrete, this.id);
    ...
    AbstractFormComponent.prototype.addError = function (type, message) {
        var _this = this;
        var error = new formError.FormError(this.path, type, message);
        this.errors.push(error);
        this.markBasicState(constant.BasicState.Invalid, this.id);
        this.dispatch(constant.FormEvents.ErrorsChanged, function () { return new errorsChanged_formEvent.ErrorsChangedFormEvent(_this, _this.errors.slice(0)); });
    };
    /**
    ...
    AbstractFormComponent.prototype.clearErrors = function (silent) {
        ...
        if (!silent) {
            ...
            this.dispatch(constant.FormEvents.ErrorsChanged, function () { return new errorsChanged_formEvent.ErrorsChangedFormEvent(_this, []); });
        }
    };
    /**
    ...
    AbstractFormComponent.prototype.matchPattern = function (pattern) {
        return matchBest.matchBest(ensureArray.ensureArray(pattern), this.path, this.activeStates.concat(this.additionalPatternTags));
    };
    /**
     * Get all extra data.
     */
    ...
    AbstractFormComponent.prototype.getExtra = function (name, defaultValue) {
        if (isUndefined.isUndefined(this.extras[name])) {
            return defaultValue;
        }
    ...
    AbstractFormComponent.prototype.onValueChanged = function (callback, priority, selfOnly) {
        ...
        return this.subscribe(constant.FormEvents.ValueChanged, callback, priority, selfOnly);
    };
    /**
    ...
    AbstractFormComponent.prototype.onStateChanged = function (callback, priority, selfOnly) {
        if (selfOnly === void 0) { selfOnly = true; }
        return this.subscribe(constant.FormEvents.StateChanged, callback, priority, selfOnly);
    };
    /**
    ...
    AbstractFormComponent.prototype.onValidationStart = function (callback, priority, selfOnly) {
        return this.subscribe(constant.FormEvents.ValidationStart, callback, priority, selfOnly);
    };
    /**
    ...
    AbstractFormComponent.prototype.onValidationEnd = function (callback, priority, selfOnly) {
        return this.subscribe(constant.FormEvents.ValidationEnd, callback, priority, selfOnly);
    };
    /**
    ...
    AbstractFormComponent.prototype.onErrorsChanged = function (callback, priority, selfOnly) {
        if (selfOnly === void 0) { selfOnly = true; }
        return this.subscribe(constant.FormEvents.ErrorsChanged, callback, priority, selfOnly);
    };
    /**
    ...
    AbstractFormComponent.prototype.subscribe = function (type, callback, priority, selfOnly) {
        ...
        if (!selfOnly && !isUndefined.isUndefined(constant.EventsInheritanceMap[type])) {
            unsubscribeFunctions.push(dispatcher.subscribe(constant.EventsInheritanceMap[type], callback));
        }
        return function () {
    ...
    AbstractFormComponent.prototype.doReset = function () {
        ...
        this.unmarkBasicState([constant.BasicState.Touched, constant.BasicState.Dirty], this.id);
        this.validationStatus = constant.ValidationStatus.Unknown;
        this.clearErrors();
    };
    /**
    ...
    AbstractFormComponent.prototype.getConcreteValidationStrategy = function () {
        if (this.validationStrategy === constant.ValidationStrategy.Inherit) {
            return this.parent !== null ? this.parent.getConcreteValidationStrategy() : constant.DefaultValidationStrategy;
        }
    ...
    AbstractFormComponent.prototype.getConcreteValidationGroups = function () {
        if (this.validationGroups === constant.InheritValidationGroup) {
            return this.parent !== null ? this.parent.getConcreteValidationGroups() : [];
        }
        return ensureArray.ensureArray(this.validationGroups);
    };
    /**
     * Dispatch an event.
     */
    AbstractFormComponent.prototype.dispatch = function (type, event) {
        if (this.eventDispatcher !== null) {
            if (isFunction.isFunction(event)) {
                event = event();
            }
    ...
    AbstractFormComponent.prototype.doValidate = function (validator, isDeep) {
        ...
        var validationStartEvent = new formEvent.FormEvent(this);
        this.dispatch(constant.FormEvents.ValidationStart, function () { return validationStartEvent; });
        if (validator === null || validationStartEvent.defaultPrevented) {
            // An empty validation result is always sync and valid.
            var result_1 = new validationResult.ValidationResult('/');
            this.handleValidationResult(result_1, isDeep);
            return true;
        }
        var groups = this.getConcreteValidationGroups();
        var context = new formValidationContext.FormValidationContext(this.root, this.path, null, null, this.value, undefined, groups);
    ...
    AbstractFormComponent.prototype.hasContext = function (context) {
        for (var _i = 0, _a = this.contextsStack; _i < _a.length; _i++) {
            var candidate = _a[_i];
            if (context === constant.CallContext.External) {
    ...
    AbstractFormComponent.prototype.getCallContextComponentId = function (context) {
        return constant.ComponentRelatedCallContexts.indexOf(context) > -1 ? this.id : 0;
    };
    /**
    ...
    AbstractFormComponent.prototype.resolveStateCallContext = function () {
        var contexts = [];
        for (var _i = 0, _a = [constant.CallContext.ViewModel, constant.CallContext.Parent, constant.CallContext.Child]; _i < _a.length; _i++) {
            var candidate = _a[_i];
        ...
        if (contexts.length > 1) {
            throw new usage_exception.UsageException('Try to update a state while multiple suitable call contexts are available.');
        }
        return contexts.length > 0 ? contexts[0] : constant.CallContext.External;
    };
    /**
    ...
    AbstractFormComponent.prototype.buildContextualizedApi = function (exposedMethodsMap, context) {
        var api = {};
        for (var _i = 0, _a = getObjectKeys.getObjectKeys(exposedMethodsMap); _i < _a.length; _i++) {
            var alias = _a[_i];
    ...
    AbstractFormComponent.prototype.markAsDisabled = function () {
        this.markContextualizedState(constant.ContextualizedState.Disabled);
    };
    /**
    ...
    AbstractFormComponent.prototype.markAsEnabled = function () {
        this.unmarkContextualizedState(constant.ContextualizedState.Disabled);
    };
    /**
    ...
    AbstractFormComponent.prototype.dispatchStateChange = function (state, newValue) {
        var _this = this;
        this.dispatch(constant.FormEvents.StateChanged, function () { return new stateChanged_formEvent.StateChangedFormEvent(_this, state, newValue); });
    };
    /**
    ...
    AbstractFormComponent.prototype.markBasicState = function (state, id) {
        var _this = this;
        var states = ensureArray.ensureArray(state);
        var _loop_1 = function (state_1) {
            if (this_1.basicStates[state_1].indexOf(id) < 0) {
                ...
                this_1.dispatch(constant.FormEvents.StateChanged, function () { return new stateChanged_formEvent.StateChangedFormEvent(_this, state_1, true); });
            }
    ...
    AbstractFormComponent.prototype.unmarkBasicState = function (state, id) {
        ...
        var _loop_2 = function (state_2) {
            ...
            if (pos > -1) {
                ...
                this_2.dispatch(constant.FormEvents.StateChanged, function () { return new stateChanged_formEvent.StateChangedFormEvent(_this, state_2, false); });
            }
    ...
    AbstractFormComponent.prototype.markContextualizedState = function (state) {
        ...
        if (isUndefined.isUndefined(this.contextualizedStates[state][context])) {
    ...
    AbstractFormComponent.prototype.updateActiveState = function (state, inverted) {
        var toRemove = inverted ? state : constant.StatesInverseMap[state];
        var toAdd = inverted ? constant.StatesInverseMap[state] : state;
        if (this.activeStates.indexOf(toAdd) < 0) {
            this.activeStates.push(toAdd);
        }
        removeFromArray.removeFromArray(this.activeStates, toRemove);
    };
    /**
