...
var themeVariant_event = require('./event/theme-variant.event.js');
...
var VueThemeVariant = /** @class */ (function () {
    function VueThemeVariant(theme, selector, eventDispatcher) {
         ...
         */
        this.uid = getUniqueRandomId.getUniqueRandomId();
        /**
    ...
    VueThemeVariant.prototype.cssVars = function (map) {
        Object.assign(this.cssVarsMap, flattenObject.flattenObject(map));
        this.scheduleChangeNotification();
        return this;
    };
    /**
    ...
    VueThemeVariant.prototype.cssSelectors = function (map) {
        var flattened = flattenObject.flattenObject(map, '.', -1);
        for (var _i = 0, _a = Object.keys(flattened); _i < _a.length; _i++) {
            var selector = _a[_i];
            if (isUndefined.isUndefined(this.cssSelectorsMap[selector])) {
                this.cssSelectorsMap[selector] = {};
            }
            if (isObject.isObject(flattened[selector])) {
                for (var _b = 0, _c = Object.keys(flattened[selector]); _b < _c.length; _b++) {
                    var rule = _c[_b];
                    var normalizedRule = kebabCase.kebabCase(rule);
    ...
    VueThemeVariant.prototype.apply = function (ids) {
        this.applyIds = ensureArray.ensureArray(ids);
        return this;
    };
    /**
    ...
    VueThemeVariant.prototype.priority = function (priority) {
        ...
        this.eventDispatcher.dispatch(constant.ThemesEvents.VariantPriorityChanged, new themeVariant_event.ThemeVariantEvent(this));
        return this;
    };
    /**
    ...
    VueThemeVariant.prototype.use = function (component, configuration) {
        ...
        this.eventDispatcher.dispatch(constant.ThemesEvents.VariantUsed, new themeVariant_event.ThemeVariantEvent(this));
    };
    /**
    ...
    VueThemeVariant.prototype.onUse = function (cb) {
        return this.eventDispatcher.subscribe(constant.ThemesEvents.VariantUsed, cb);
    };
    /**
     * Be notified when the priority of the variant is modified.
     */
    VueThemeVariant.prototype.onPriorityChange = function (cb) {
        return this.eventDispatcher.subscribe(constant.ThemesEvents.VariantPriorityChanged, cb);
    };
    /**
     * Immediately notify listeners that a change occurred.
     */
    VueThemeVariant.prototype.notifyChange = function () {
        this.eventDispatcher.dispatch(constant.ThemesEvents.VariantUpdated, new themeVariant_event.ThemeVariantEvent(this));
    };
    return VueThemeVariant;
}());

exports.VueThemeVariant = VueThemeVariant;
