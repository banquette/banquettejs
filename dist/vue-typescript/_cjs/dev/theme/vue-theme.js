...
var getUniqueRandomId = require('../utils/get-unique-random-id.js');
var constant = require('./constant.js');
var themeComponentChanged_event = require('./event/theme-component-changed.event.js');
var theme_event = require('./event/theme.event.js');
var injectContextInCssSource = require('./utils/inject-context-in-css-source.js');
var normalizeVariantSelector = require('./utils/normalize-variant-selector.js');
var vueThemeVariant = require('./vue-theme-variant.js');
...
var VueTheme = /** @class */ (function () {
    function VueTheme(name, eventDispatcher) {
         ...
         */
        this.usageCount = 0;
        this.id = getUniqueRandomId.getUniqueRandomId();
    }
    /**
     * Get all variants of a component.
     */
    VueTheme.prototype.getVariants = function (componentName) {
        return !isUndefined.isUndefined(this.variants[componentName]) ? this.variants[componentName].variants : [];
    };
    /**
    ...
    VueTheme.prototype.getVariant = function (selector, componentName) {
        var _this = this;
        var normalizedVariantSelector = normalizeVariantSelector.normalizeVariantSelector(selector);
        var variantId = normalizedVariantSelector.identifier;
        if (isUndefined.isUndefined(this.variants[componentName])) {
            this.variants[componentName] = { variants: [], variantsIndex: {}, styleElement: null };
        }
        if (isUndefined.isUndefined(this.variants[componentName].variantsIndex[variantId])) {
            var variant_1 = new vueThemeVariant.VueThemeVariant(this, normalizedVariantSelector, this.eventDispatcher);
    ...
    VueTheme.prototype.removeVariant = function (selector, componentName) {
        var variantId = normalizeVariantSelector.normalizeVariantSelector(selector).identifier;
        if (!isUndefined.isUndefined(this.variants[componentName]) && !isUndefined.isUndefined(this.variants[componentName].variantsIndex[variantId])) {
    ...
    VueTheme.prototype.use = function () {
        ++this.usageCount;
        this.injectInDOM();
        this.eventDispatcher.dispatch(constant.ThemesEvents.ThemeChanged, new theme_event.ThemeEvent(this));
    };
    /**
    ...
    VueTheme.prototype.free = function () {
        ...
        this.eventDispatcher.dispatch(constant.ThemesEvents.ThemeChanged, new theme_event.ThemeEvent(null));
    };
    /**
    ...
    VueTheme.prototype.injectInDOM = function () {
        ...
        for (var _i = 0, _a = Object.keys(this.variants); _i < _a.length; _i++) {
            ...
            for (var _b = 0, _c = component.variants; _b < _c.length; _b++) {
                ...
                var variantStyles = trim.trim(variant.rawCss);
                for (var _d = 0, _e = Object.keys(variant.cssSelectorsMap); _d < _e.length; _d++) {
                    ...
                    var _loop_1 = function (selectorKey) {
                        ...
                        for (var _h = 0, selectorKeyParts_1 = selectorKeyParts; _h < selectorKeyParts_1.length; _h++) {
                            ...
                            if (isUndefined.isUndefined(matchingSelector)) {
                ...
                if (variantStyles.length > 0) {
                    variantStyles = injectContextInCssSource.injectContextInCssSource(variantStyles, variant.theme.id, "data-".concat(variant.uid), variant.scopeId);
                    variantStyles += "\n";
                }
                ...
                if (cssVarsKeys.length > 0) {
                    ...
                    for (var _g = 0, cssVarsKeys_1 = cssVarsKeys; _g < cssVarsKeys_1.length; _g++) {
                        ...
                        if (!isUndefined.isUndefined(variant.configuration.css.vars[key])) {
            ...
            if (componentStyles.length > 0) {
                if (component.styleElement === null) {
                    ...
                    if (this.name === constant.ThemeWildcard) {
    ...
    VueTheme.prototype.notifyComponentChange = function (name) {
        this.eventDispatcher.dispatch(constant.ThemesEvents.ThemeComponentChanged, new themeComponentChanged_event.ThemeComponentChangedEvent(this, name));
    };
    /**
     * Subscribe to an event that will trigger each time a variant is modified.
     */
    VueTheme.prototype.onUpdated = function (cb) {
        return this.eventDispatcher.subscribe(constant.ThemesEvents.VariantUpdated, cb);
    };
    /**
    ...
    VueTheme.prototype.onComponentsChange = function (componentsNames, cb) {
        var _this = this;
        return this.eventDispatcher.subscribe(constant.ThemesEvents.ThemeComponentChanged, function (event) {
