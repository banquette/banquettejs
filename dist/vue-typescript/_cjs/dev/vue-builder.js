...
var VueBuilder = /** @class */ (function () {
    ...
    VueBuilder.RegisterComponent = function (name, component, group) {
        ...
        var groups = ensureArray.ensureArray(group);
        for (var _i = 0, groups_1 = groups; _i < groups_1.length; _i++) {
            var group_1 = groups_1[_i];
            if (isUndefined.isUndefined(VueBuilder.Components[group_1])) {
    ...
    VueBuilder.RegisterDirective = function (name, directive, group, ctor) {
        ...
        for (var _i = 0, groups_2 = groups; _i < groups_2.length; _i++) {
            ...
            if (group_2 !== null) {
                if (isUndefined.isUndefined(VueBuilder.Directives[group_2])) {
    ...
    VueBuilder.GetDirectiveDefinition = function (ctor) {
        if (!VueBuilder.DirectivesConstructorsMap.has(ctor)) {
            throw new usage_exception.UsageException("No directive definition found for ".concat(ctor.name || '(Unnamed constructor)', "."));
        }
    ...
    VueBuilder.ApplyToExistingApp = function (app, group, options) {
        ...
        var groups = (group === '*' ? Object.keys(VueBuilder.Components).concat(Object.keys(VueBuilder.Directives)) : ensureArray.ensureArray(group));
        ...
        for (var _b = 0, groups_3 = groups; _b < groups_3.length; _b++) {
            ...
            if (!isUndefined.isUndefined(VueBuilder.Components[group_3])) {
            ...
            if (!isUndefined.isUndefined(VueBuilder.Directives[group_3])) {
    ...
    VueBuilder.MergeVueOptions = function () {
        ...
        for (var i = 1; i < args.length; ++i) {
            ...
            for (var _a = 0, _b = Object.keys(obj); _a < _b.length; _a++) {
                var key = _b[_a];
                if (isFunction.isFunction(output[key])) {
                ...
                else if (isObject.isObject(obj[key])) {
