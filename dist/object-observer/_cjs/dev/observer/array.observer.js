...
var ArrayObserver = /** @class */ (function (_super) {
    _tslib.__extends(ArrayObserver, _super);
    function ArrayObserver() {
        ...
        _this.proxifiedPop = function () {
            ...
            _this.notify(new mutation.Mutation(constant.MutationType.Delete, [String(_this.proxy.length)], removedItem, undefined, _this.target));
            return removedItem;
        };
        /**
        ...
        _this.proxifiedShift = function () {
            ...
            _this.detachValue(removedItem);
            _this.notify(new mutation.Mutation(constant.MutationType.Delete, ['0'], removedItem, undefined, _this.target));
            return removedItem;
        };
        /**
        ...
        _this.proxifiedUnshift = function () {
            ...
            for (var i = 0; i < args.length; ++i) {
                _this.notify(new mutation.Mutation(constant.MutationType.Insert, [String(i)], undefined, args[i], _this.target));
            }
        ...
        _this.proxifiedReverse = function () {
            if (_this.target.length > 0) {
                ...
                _this.reassignNames();
                _this.notify(new mutation.Mutation(constant.MutationType.Reverse, [], undefined, _this.proxy, _this.target));
            }
            return _this.proxy;
        };
        /**
        ...
        _this.proxifiedSort = function (compareFn) {
            if (_this.target.length > 0) {
                ...
                _this.reassignNames();
                _this.notify(new mutation.Mutation(constant.MutationType.Sort, [], undefined, _this.proxy, _this.target));
            }
            return _this.proxy;
        };
        /**
        ...
        _this.proxifiedSplice = function (start, deleteCount) {
            ...
            for (var i = 0; i < spliceResult.length; ++i) {
                ...
                _this.notify(new mutation.Mutation(constant.MutationType.Delete, [String(positiveStart + i)], spliceResult[i], undefined, _this.target));
            }
            for (var i = 0; i < newItems.length; ++i) {
                _this.target[positiveStart + i] = _this.observeProperty(String(i), newItems[i]);
                _this.notify(new mutation.Mutation(constant.MutationType.Insert, [String(positiveStart + i)], undefined, _this.target[positiveStart + i], _this.target));
            }
            _this.reassignNames();
            return spliceResult;
        };
    ...
    ArrayObserver.prototype.get = function (target, key) {
        if (isUndefined.isUndefined(ArrayObserver.ArrayOverrides[key])) {
            return target[key];
        }
    ...
    ArrayObserver.prototype.reassignNames = function () {
        for (var i = 0; i < this.target.length; i++) {
            var observer = utils.extractObserver(this.target[i]);
            if (observer !== null) {
